...
./ospf -f infile.txt -o out -i 7 2> o7.txt 1>&2 &
./ospf -f infile.txt -o out -i 8 2> o7.txt 1>&2 &
./ospf -f infile.txt -o out -i 9 2> o7.txt 1>&2 &
./ospf -f infile.txt -o out -i 10 2> o7.txt 1>&2
