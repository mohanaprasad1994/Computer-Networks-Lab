...
main (int argc, char *argv[])
{
  ...
  csma.SetChannelAttribute ("Delay", TimeValue (NanoSeconds (25000)));
  ...
  ApplicationContainer serverApps2 = echoServer2.Install (csmaNodes.Get (5));
  serverApps2.Start (Seconds (1.0));
  serverApps2.Stop (Seconds (50.0));

  
  UdpEchoClientHelper echoClient2 (csmaInterfaces.GetAddress (5), 10);
