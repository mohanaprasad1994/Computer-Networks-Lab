...
int main (int argc, char *argv[])
{
  ...
  else if (tcp_variant.compare("TcpG") == 0)
    Config::SetDefault("ns3::TcpL4Protocol::SocketType", TypeIdValue (TcpG::GetTypeId()));
  else
    {
...
//
  ...
  app->Setup (ns3TcpSocket, sinkAddress, 1040, 100000, DataRate ("200Kbps"));
