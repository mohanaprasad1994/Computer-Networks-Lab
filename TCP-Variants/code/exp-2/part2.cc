...
int main (int argc, char *argv[])
{
  ...
  //cmd.AddValue ("variant","TCP variant", tcp_variant);
...
//
 ...
 // TcpReno connfection from N0 to N2
  ...
  // Create and bind the TcpReno socket on node1
  TypeId tid = TypeId::LookupByName ("ns3::TcpG");
  std::stringstream nodeId;
  nodeId << c.Get (0)->GetId ();
  std::string specificNode = "/NodeList/" + nodeId.str () + "/$ns3::TcpL4Protocol/SocketType";
  Config::Set (specificNode, TypeIdValue (tid));
  Ptr<Socket> ns3TcpSocket_n0_n2 = Socket::CreateSocket (c.Get (0), TcpSocketFactory::GetTypeId ());

  // Trace Congestion window
  ns3TcpSocket_n0_n2->TraceConnectWithoutContext ("CongestionWindow", MakeCallback (&CwndChange));

  // Create TCP application at n0
  Ptr<MyApp> app = CreateObject<MyApp> ();
  app->Setup (ns3TcpSocket_n0_n2, sinkAddress, 1040, 100000, DataRate ("300Kbps"));
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // TcpTahoe connfection from N1 to N3
  ...
  sinkApps2.Stop (Seconds (100.));
     ...
     // Create and bind the TcpTahoe socket on node1
  tid = TypeId::LookupByName ("ns3::TcpTahoe");
  
  nodeId << c.Get (1)->GetId ();
  specificNode = "/NodeList/" + nodeId.str () + "/$ns3::TcpL4Protocol/SocketType";
  Config::Set (specificNode, TypeIdValue (tid));
  Ptr<Socket> ns3TcpSocket_n1_n3 = Socket::CreateSocket (c.Get (1), TcpSocketFactory::GetTypeId ());

   
  // Trace Congestion window for n1-n3 line
  //ns3TcpSocket_n1_n3->TraceConnectWithoutContext ("CongestionWindow", MakeCallback (&CwndChange));

  // Create application at n1
  Ptr<MyApp> app2 = CreateObject<MyApp> ();
  app2->Setup (ns3TcpSocket_n1_n3, sinkAddress2, 1040, 100000, DataRate ("300Kbps"));
...
//TcpNewRino on node1
  ...
  specificNode = "/NodeList/" + nodeId.str () + "/$ns3::TcpL4Protocol/SocketType";
  Config::Set (specificNode, TypeIdValue (tid));
  Ptr<Socket> ns3TcpSocket_n1_n2 = Socket::CreateSocket (c.Get (1), TcpSocketFactory::GetTypeId ());

   
  // Trace Congestion window for n1-n3 line
  //ns3TcpSocket_n1_n2->TraceConnectWithoutContext ("CongestionWindow", MakeCallback (&CwndChange));

  // Create application at n1
  Ptr<MyApp> app3 = CreateObject<MyApp> ();
  app3->Setup (ns3TcpSocket_n1_n2, sinkAddress, 1040, 100000, DataRate ("300Kbps"));
